...
class TestDatetime(unittest.TestCase):
    ...
    def test_complete(self):
        ...
        self.assert_datetime(date, time, "1966241T053532-0600")
        self.assert_datetime(date, time, "1966241T053532-06")
        self.assert_datetime(date, time, "1966-241T05:35:32")
        self.assert_datetime(date, time, "1966-241T12:35:32Z")
        self.assert_datetime(date, time, "1966-241T05:35:32-0600")
        self.assert_datetime(date, time, "1966-241T05:35:32-06")

        self.assert_datetime(date, time, "1966W351T053532")
        self.assert_datetime(date, time, "1966W351T123532Z")
        self.assert_datetime(date, time, "1966W351T053532-0600")
        self.assert_datetime(date, time, "1966W351T053532-06")
        self.assert_datetime(date, time, "1966-W35-1T05:35:32")
        self.assert_datetime(date, time, "1966-W35-1T12:35:32Z")
        self.assert_datetime(date, time, "1966-W35-1T05:35:32-0600")
        self.assert_datetime(date, time, "1966-W35-1T05:35:32-06")
